...
class NetworkInterface {
  private:
    ...
    std::map<uint32_t, EthernetAddress> _addr_table{};
    std::map<uint32_t, int> _ARP_status{};
    std::vector<std::pair<Address, InternetDatagram>> _waiting_dgram{};

    void waiting_dgram_check();
